    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Source list</h4>
            </div>
        ...
        <!-- /.row -->
        <source-modal :dialog-visible.sync="dialogVisible" :dialog-title.sync="dialogTitle"/>
    </div>
</template>
        ...
        methods: {
            ...
            destroy(id, index) {
                MessageBox.confirm(
                    ...
                    .then(() => {
                        axios.delete(this.$baseURL + "library/sources/" + id)
                            .then(response => {
            ...
            edit(library, index) {
                this.$eventBus.$emit('edit-source', library);
            }
        },
        created() {
            this.$emit("update:layout", MasterLayout);
            this.$eventBus.$on("add-source", library => {
                this.libraries.total++;
