...
class PurchaseRequisitionController extends BaseController
{
    ...
    public function store(PurchaseRequisitionRequest $request)
    {
        ...
        $supplier = PurchaseRequisition::create($validated);
        return $this->sendResponse($supplier, 'Purchase requisition has been created successfully.');
    }
    ...
    {
        $supplier = PurchaseRequisition::findOrFail($id);
        return $this->sendResponse($supplier, 'Purchase requisition retrieved successfully.');
    }
